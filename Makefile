...
GO_MODULES    := ./shared/... ./services/auth/... ./services/chat/... ./services/gateway/... ./services/game/...
...
test-integration: ## Run integration tests (testcontainers spins up Postgres)
	cd core && go test -tags integration -count=1 ./services/auth/integration/... ./services/chat/integration/... ./shared/integration/...
...
tidy: ## Tidy every module in the workspace
	@for module in shared services/auth services/chat services/gateway services/game; do \
		echo "tidy $$module"; \
